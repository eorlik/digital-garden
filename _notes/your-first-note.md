...
- Using the note title: [[Take a rake to it]]
- Using the note's filename: [[take a rake to it]]
- Using the note's title, with a label: [[Take a rake to it|link to the note about cats using the note title]]
- Using the note's filename, with a label: [[take a rake to it|link to the note about cats using the note's filename]]
